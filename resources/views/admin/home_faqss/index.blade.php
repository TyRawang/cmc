...
<div class="container-fluid">
    <div class="block-header">
         <a class="btn bg-blue waves-effect" href="{{ route('home-faqss.create') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped js-basic-example table-hover dataTable">
                            ...
                            <tbody>
                                ...
                                @foreach($home_faqsss as $key => $value)
                                <tr class="text-left">
                                    <td>{{ $key+1 }}</td>
                                    <td>
                                    ...
                                    <td>                                       
                                        ...
                                        <a href="{{ route('home-faqss.edit',['home_faqss' => $value->id]) }}" class="btn btn-success btn-xs waves-effect"><i class="material-icons">edit</i></a>
                                        <form id="form1" method="POST" style="display: inline-block;" action="{{ route('home-faqss.destroy',['id' => $value->id]) }}">
                                        @csrf
                                        @method('DELETE')
