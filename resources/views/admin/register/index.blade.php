                        ...
                        <table class="table table-bordered table-striped js-basic-example table-hover dataTable">
                            ...
                            <tbody>
                                ...
                                <tr class="text-left">
                                   ...
                                   <td>
                                        @if (null <> $value->name)
                                        {{ substr(strip_tags($value->name),0,60) }}
                                        @else
                                        --
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('register.edit',['home_category' => $value->id]) }}" class="btn btn-success btn-xs waves-effect"><i class="material-icons">edit</i></a>
